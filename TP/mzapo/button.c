...
int main(int argc, char *argv[]) {
    ...
    while (1) {
        ...
        struct timespec loop_delay = {.tv_sec = 2};
        ...
        *(volatile uint32_t *) (mem_base + SPILED_REG_LED_LINE_o) = rgb_knobs_value;
        ...
        uint32_t x_value = (uint_val & 0x00FF0000) >> 16;
        double t = 6 / 255;
        if (x_value != last_x) {
            printf("%d\n", x_value);
            fractal = generate_julia(WIDTH, HEIGHT, t * x_value - 3, move_y, c_real, c_imag, 400);
...
/*
0x0018fcc8 // chci 0x00 - klinkuti na tlacitko, R = 4, G = 2, B = 1
(0x0018fcc8 & 0xFF000000)>>24

0x0018fcc8 //chci 0x18
(0x0018fcc8 & 0x00FF0000) >>16
